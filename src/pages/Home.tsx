      ...
      <section id="services" className="py-20 px-8 md:px-20 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-500 mb-12 max-w-lg">
            Every service tailored to your eye shape, lifestyle, and personal style.
          </p>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="oswald text-4xl font-bold text-gray-900 mb-4">
              10+ Years of Lash Artistry in London.
            </h2>
            <p className="text-gray-500 leading-relaxed mb-4">
              Shamsa has been perfecting lash extensions and brow treatments in London, ON for over a decade — working out of a private, relaxing studio that feels more like a spa than a salon.
            </p>
            <p className="text-gray-500 leading-relaxed mb-6">
              With 149+ five-star reviews, she's the go-to lash artist in southwest London for clients who want real results and a flawless, natural look.
            </p>
      ...
      <section id="contact" className="py-20 px-8 md:px-20" style={{ background: business.colorDark }}>
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-slate-400 mb-12 max-w-lg">
            Send a message and Shamsa will get back to you quickly to find a time that works.
          </p>
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <textarea rows={4} placeholder="Tell me what you're looking for..." className="border border-white/10 rounded-lg px-4 py-3 text-white text-sm placeholder-slate-500 focus:outline-none resize-none" style={{ background: "rgba(255,255,255,0.07)" }} />
              </div>
